...
rem status.bat
rem
rem Display the status of all services in the Diaries local-published-smoke
rem Compose stack.
rem ============================================================================
...
rem ----------------------------------------------------------------------------
rem Display the stack status.
rem ----------------------------------------------------------------------------

echo Diaries local-published-smoke stack status
...
if not "%EXIT_CODE%"=="0" (
    echo ERROR: Unable to obtain Diaries local-published-smoke stack status. >&2
    goto :cleanup
)
