...
rem client/web/responder tags. The actual set-env.bat should remain machine/local
...
rem Selection precedence for the web reader:
rem   DIARIES_WEB_IMAGE_TAG
rem   DIARIES_IMAGE_TAG
rem   integration
rem ============================================================================

rem To use one tag for all application images:
rem set "DIARIES_IMAGE_TAG=0.0.9"
rem set "DIARIES_CLIENT_IMAGE_TAG="
rem set "DIARIES_WEB_IMAGE_TAG="
