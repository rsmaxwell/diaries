...
rem ============================================================================
rem backup-to-binary.bat
rem
rem Back up the Diaries PostgreSQL database used by local-published-smoke mode in
...
rem
rem The committed local-published-smoke environment is loaded first and local.env
...
set "BACKUP_FILE=%BACKUP_DIR%\diaries-local-published-smoke-%TIMESTAMP%.dump"
...
echo Backing up the local-published-smoke database...
