...
rem ============================================================================
rem backup-to-sql.bat
rem
rem Back up the Diaries PostgreSQL database used by local-docker-build mode as
...
set "BACKUP_FILE=%BACKUP_DIR%\diaries-local-docker-build-%TIMESTAMP%.sql"
...
echo Backing up the local-docker-build database as SQL...
